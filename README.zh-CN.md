...
我正在构建以人为本的具身智能体系统，把感知、状态建模、规划和动作整合在一起。具体来说，是在 Aloha、Astribot 等具身平台上，研究如何融合 EEG、视觉和行为信号，做出更自然、更可靠的多模态 AI 系统。

不同于传统对话机器人，我更倾向于做「懂人的智能系统」，围绕闭环架构展开：感知 → 状态估计 → 决策 → 执行 → 反馈。
